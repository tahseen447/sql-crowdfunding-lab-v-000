...
"select projects.title, sum(pledges.amount) - project.funding_goal from projects join pledges on pledges.project_id=projects.id group by projects.project_id;"
end
